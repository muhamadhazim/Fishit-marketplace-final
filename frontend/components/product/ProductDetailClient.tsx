...
import { Fish, CreditCard, User, Gamepad2, ShoppingCart, AlertCircle, Store } from "lucide-react";
    ...
    <div className="mx-auto max-w-6xl p-6 animate-fade-in">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col">
          ...
          {product.seller && (
            <div className="mb-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-web3-accent-purple/10 border border-web3-accent-purple/30">
                <Store className="h-5 w-5 text-web3-accent-purple" />
                <span className="text-web3-text-secondary">PENJUAL:</span>
                <span className="text-web3-accent-purple font-semibold">{product.seller.username}</span>
              </div>
            </div>
          )}
          ...
          {/* Specifications */}
          <section>
            <h2 className="text-xl font-bold text-web3-text-primary mb-4">Spesifikasi</h2>
